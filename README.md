...
It is a Quiz game about Christmas. All questions are related to Christmas and it is fun to test your knowledge about this Holiday. It's purpose is for the user to have fun and test their general knowledge on this subject.
This site is targeted towards children and adults.
...
## Features
 ...
 - ### Questions
   ...
   - When the answer is selected a new question will apear.
   - Each question will have a number to it from 1-10
   - Written in a clear language and readable font
        ![Question area of the Christmas Quiz game](/assets/media/Questions.png)
        
 - ### Answer options
   - Each question has 2 answer options
   - Answers are inside the button and are selected by pressing on the chosen answer

        ![Answer options of the Christmas Quiz game](/assets/media/Answer_options.png)

   - When the correct answer is selected the message pops up to congratulate the user

        ![allert message for correct answer](/assets/media/correct_answer.png)

   - Wnen an incorrect answer is selected the message will say 
 - "Sorry the answer is wrong!"

        ![allert message for incorrect answer](/assets/media/incorrect_answer.png)

 - ### Next button
   - After the answer been selected a Next button will be displayed and when clicked on, will open a new question and answer options.
      ![Next button](/assets/media/next_button.png)

- ### End of the Quiz
  - After the last question has been answered "Thank you for playing!" message will appear indicating that the quiz is finished.
  - A Next button will change to Reset button, when clicked on it will start the Quiz from the beginning.
  - The score will appear below the Reset button to show the user their total score
...
- Add keydown to the Next button so when Enter is pressed on the keyboard it automatically selects Next.
- Remove alert messages when the answer option is selected and instead change color of the selected answer. Red when incorrect and green when the answer is selected correctly.
- When an answer is chosen to not allow the user to choose a different answer
...
- Tested to make sure that the quiz result are always correct
...
- ### Content
  - Text for the quiz questions were taken from :
[Cosmopolitan](https://www.cosmopolitan.com/uk/worklife/a34747711/christmas-quiz-questions/)
 ...
 - The icons for the Header are from [Fontawsome](https://fontawesome.com)
